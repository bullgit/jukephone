...
<Response>
  <?php if ($songfile): ?>
    ...
    <Say language="en-EN">You are now listening to <?php echo $songtitle ?> from <?php echo $songartist ?>.</Say>
  ...
  <?php else: ?>
    ...
    <Say language="en-EN">A Song with this number doesn't exist, bye.</Say>
  <?php endif ?>
</Response>
