...
<Response>
  ...
  <Say voice="alice" language="en-US">Hello <?php echo $name ?>!</Say>
  <Gather action="/song.php">
    <!-- <Say language="de-DE">Suche dir ein Lied von der Liste mit den Zahlen aus und bestätige mit Raute.</Say> -->
    <Say voice="alice" language="en-US">Choose a Song from the list with the keypad and confirm with the hash.</Say>
  </Gather>
</Response>
